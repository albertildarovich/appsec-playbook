...
[LOW] **Развёрнут** через Docker на `http://localhost:3000`
...
Весь процесс разбит на **24 модуля в 5 фазах** — от разведки до финального отчёта.

 **[➡ Открыть план стажировки](./internship-plan.md)**

```
Фаза 1: Recon & Architecture    [██████████] 100%  (модули 1-3)
Фаза 2: Threat Modeling          [██████████] 100%  (модуль 4)
Фаза 3: Security Testing         [██████████] 100%  (модули 5-16)
Фаза 4: DevSecOps & Automation   [███████░░░]  57%  (модули 15-17, 24)
...
- [x] Модуль 24: ГОСТ Р 56939-2024 (безопасная разработка ПО)
